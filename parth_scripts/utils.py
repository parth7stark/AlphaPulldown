...
def get_user_temp_dir():
    if "RAY_TMPDIR" in os.environ:
        print("1st if: ", os.environ["RAY_TMPDIR"])
        return os.environ["RAY_TMPDIR"]
    elif sys.platform.startswith("linux") and "TMPDIR" in os.environ:
        print("2nd if: ", os.environ["TMPDIR"])
        #/var/tmp/pbs.1144510.polaris-pbs-01.hsn.cm.polaris.alcf.anl.gov
        tempdir = "/tmp/"
        return tempdir
...
def get_ray_temp_dir():
    print("\n get_ray_temp_dir", get_user_temp_dir())
